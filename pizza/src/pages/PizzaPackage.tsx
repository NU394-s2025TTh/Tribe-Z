...
import { StoreIngredientCard } from '../components/StoreIngredientCard';
import { useState, useEffect } from 'react';

function PizzaPackage() {
    const [searchParams] = useSearchParams();
    const pizzaName = searchParams.get('pizza');
    const formattedPizzaName = pizzaName ? pizzaName.charAt(0).toUpperCase() + pizzaName.slice(1) : '';
  
    const [storeToIngredients, setStoreToIngredients] = useState<Record<string, any[]>>({});
